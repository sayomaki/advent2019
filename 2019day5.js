...
const stdinBuffer = fs.readFileSync('./2019day5.txt');
...
const mainV2 = (ops) => {
  ...
  while ((op == 1 || op == 2 || op == 3 || op == 4) && op != 99) {
    if (op == 1) {
...
console.log('Part 1:', mainV2(state1));
...
console.log('Part 2:', mainV3(state2));